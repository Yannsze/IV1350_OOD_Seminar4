...
public class Controller {
    ...
    */
    ...
    public void initializeSale() {
        sale = new Sale();
        sale.addTotalObserver(totalRevenueView);
        sale.addTotalFileOutPut(totalRevenueFileOutput);
    }
     ...
     * @throws DatabaseConnectionException hordcoded itemID that signals database not connecting.
